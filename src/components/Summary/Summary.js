    ...
    <div>
      ...
      <div className='summary'>
        <div className='game-summary-container'>
          ...
          :
            <div className='game-summary'><Board game={game} userId={thisPlayer.uid} isPlaying={false}/></div>
          }
        ...
        <div className='game-summary-container'>
          ...
          :
            <div className='game-summary'><Board game={game} userId={secondPlayer.uid} isPlaying={false}/></div>
          }
